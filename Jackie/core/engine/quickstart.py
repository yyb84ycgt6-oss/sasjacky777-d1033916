...
Run:
    ...
    3. Run this script, as a module from the repository root — these files
       are a package now, and a relative import does not resolve when the
       file is handed to the interpreter as a path:
